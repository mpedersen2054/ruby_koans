...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # the argument is first used for the first item in the array, and the
    # operation in the block is executed for each other item in the array
  end
  ...
  #
  # because it needs to do something for each line
  #
