...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  #
  # as many occurances as possible are matched while allowing the overall match to succeed
  ...
  #
  # (|) will check each item sequentially, where ([]) will search for all at once
  # ------------------------------------------------------------------
